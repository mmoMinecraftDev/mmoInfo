	...
	public void onSpoutCraftPlayer(SpoutPlayer player) {
		...
		if (token_lines >= 2) {
			...
			screen.attachWidget(
					...
					.setAlign(WidgetAnchor.TOP_LEFT)
					.setAnchor(WidgetAnchor.TOP_LEFT).setWidth(427)
					.setHeight(10).setX(0).setY(this.offset+10));
			...
			screen.attachWidget(
					...
					.setAlign(WidgetAnchor.TOP_CENTER)
					.setAnchor(WidgetAnchor.TOP_CENTER).setWidth(427)
					.setHeight(10).setX(-213).setY(this.offset+10));
			...
			screen.attachWidget(
					...
					.setAlign(WidgetAnchor.TOP_RIGHT)
					.setAnchor(WidgetAnchor.TOP_RIGHT).setWidth(427)						
					.setHeight(10).setX(-427).setY(this.offset+10));
		...
		if (token_lines >= 3) {
			...
			screen.attachWidget(
					...
					.setAlign(WidgetAnchor.TOP_LEFT)
					.setAnchor(WidgetAnchor.TOP_LEFT).setWidth(427)
					.setHeight(10).setX(0).setY(this.offset+20));
			...
			screen.attachWidget(
					...
					.setAlign(WidgetAnchor.TOP_CENTER)
					.setAnchor(WidgetAnchor.TOP_CENTER).setWidth(427)
					.setHeight(10).setX(-213).setY(this.offset+20));
			...
			screen.attachWidget(
					...
					.setAlign(WidgetAnchor.TOP_RIGHT)
					.setAnchor(WidgetAnchor.TOP_RIGHT).setWidth(427)						
					.setHeight(10).setX(-427).setY(this.offset+20));
		...
		if (token_lines >= 4) {
			...
			screen.attachWidget(
					...
					.setAlign(WidgetAnchor.TOP_LEFT)
					.setAnchor(WidgetAnchor.TOP_LEFT).setWidth(427)
					.setHeight(10).setX(0).setY(this.offset+30));
			...
			screen.attachWidget(
					...
					.setAlign(WidgetAnchor.TOP_CENTER)
					.setAnchor(WidgetAnchor.TOP_CENTER).setWidth(427)
					.setHeight(10).setX(-213).setY(this.offset+30));
			...
			screen.attachWidget(
					...
					.setAlign(WidgetAnchor.TOP_RIGHT)
					.setAnchor(WidgetAnchor.TOP_RIGHT).setWidth(427)						
					.setHeight(10).setX(-427).setY(this.offset+30));
